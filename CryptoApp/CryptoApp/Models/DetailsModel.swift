...
/*
 https://api.coingeck o.com/api/v3/coins/__coin__?localization=false&tickers=false&market_data=false&community_data=false&developer_data=false&sparkline=false
 RESPONSE
 {
   "id": "bitcoin",
   "symbol": "btc",
   ...
   "sentiment_votes_up_percentage": 82.54,
   "sentiment_votes_down_percentage": 17.46,
   "watchlist_portfolio_users": 1421204,
   "market_cap_rank": 1,
   "status_updates": [],
   "last_updated": "2024-01-06T17:12:49.193Z"
 }
 */
